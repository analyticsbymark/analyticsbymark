...
Output:
  images/app_image_01_linkedin_preview.png  — 1200px wide, height auto-cropped
                                              just above the data table heading
...
def main() -> None:
    ...
    try:
        ...
        # the data table heading so only heading, subtitle, controls, and chart
        # are visible.
        ...
        # Image 2: Full page — expand window height to capture the data table
