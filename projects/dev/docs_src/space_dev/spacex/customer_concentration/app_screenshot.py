"""
Capture screenshots of the customer concentration Dash dashboard.

Starts the app in a background thread, uses headless Chrome to
capture two views, then exits.

Output:
  images/app_image_01_linkedin_preview.png  — Fixed 1200px wide (LinkedIn optimised)
...
def main() -> None:
    ...
    try:
        ...
        # the data table heading so only stat cards + controls + chart show.
